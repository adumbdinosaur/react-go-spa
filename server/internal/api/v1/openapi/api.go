...
type ServerInterface interface {
	...
	// CORS preflight
	// (OPTIONS /logout)
	OptionsLogout(w http.ResponseWriter, r *http.Request)
	// Log out the user
	// (POST /logout)
...
// OptionsLogout operation middleware
func (siw *ServerInterfaceWrapper) OptionsLogout(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.OptionsLogout(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options GorillaServerOptions) http.Handler {
	...
	r.HandleFunc(options.BaseURL+"/logout", wrapper.OptionsLogout).Methods("OPTIONS")

	r.HandleFunc(options.BaseURL+"/logout", wrapper.PostLogout).Methods("POST")
